  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        ...
        <div class=" ml-auto ">
          <a href="<?= site_url('products/units/add') ?>" id="units-form-add" class="btn btn-sm btn-info"><i
              ...
              <?php foreach ($units as $unit): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?= site_url('products/units/edit/' . $unit['unit_id']) ?>"
                      class="btn btn-sm btn-info mr-2"><i class="fas fa-edit"></i></a>
                    <a href="#" data-url="products/units/delete/<?= $unit['unit_id']; ?>"
