<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>Stock In<small class="text-muted"> Barang Masuk / Pembelian</small></h1>
      </div>
      <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="card">
      <div class="card-header d-flex align-items-center">
        ...
        <div class="ml-auto">
          <a href="<?= site_url('trancactions/stocks/in/add') ?>" id="stockIn-form-add" class="btn btn-sm btn-info"><i
              ...
              <?php foreach ($stocks as $stock): ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="#" class="btn btn-sm btn-info mr-2" id="show_detail" data-toggle="modal"
                      data-target="#modal-detail" data-barcode="<?= $stock['barcode']; ?>"
                      data-name="<?= $stock['item_name']; ?>" data-qty="<?= $stock['qty']; ?>"
                      data-date="<?= indo_date($stock['date']); ?>" data-suppliername="<?= $stock['supplier_name']; ?>"
                      data-detail="<?= $stock['detail']; ?>"><i class="fas fa-eye"></i></a>
                    <a href="#"
                      data-url="<?= site_url('trancactions/stocks/in/delete/' . $stock['stock_id'] . '/' . $stock['item_id']); ?>"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content p-2 pb-3">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLabel">Stock In Detail</h5>
