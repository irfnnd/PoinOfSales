<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Stock In<small class="breadcrumb-item active"> Barang Masuk / Pembelian</small></h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header d-flex align-items-center">
                ...
                <div class="ml-auto">
                    <a href="<?= base_url('trancactions/stocks/in') ?>" id="items" class="btn btn-sm btn-warning" style="color: white;">
            ...
            <div class="row p-4">
                <div class="col-md-10 offset-md-1">
                    <form action="<?= site_url('trancactions/stocks/in/save') ?>" method="post" autocomplete="off" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <div class="row">
                            <div class="col-md-5">
